...
<body>
	...
	<!--single product details-->
		...
		<div class="right-box">
			<div class="row">
				<div class="col-2">
					<img src="img/products/p8.jpg" width="100%">
				</div>
				
					<div class="product-details">
					<div class="subtitle-text"> <?php GetProName(15)?> </div>
					<div class="spacer3"></div>
					<h4> (Men) </h4>
					<div class="spacer3"></div>
			...
			<table >
				<tr>
					<td>
						...
						<label>
							<input type="radio" id="P7C1" value="14" name="Radio" checked="checked" onclick="MaxAva8(<?php echo GetStock(15)?>, <?php GetPrice(15)?>)">
							<?php GetSize(15)?> $<?php GetPrice(15)?>
						</label>
						<p style="font-family: poppins;padding-bottom:5px;">stock: <?php echo GetStock(15)?></p>
						<label>
							<input type="radio" id="P7C2" value="15" name="Radio" onclick="MaxAva8(<?php echo GetStock(16)?>, <?php GetPrice(16)?>)">
							<?php GetSize(16)?> $<?php GetPrice(16)?>
						</label>
						<p style="font-family: poppins;padding-bottom:10px;">stock: <?php echo GetStock(16)?></p>
					</td>
				</tr>
				<tr>
					<td>
						<span class="subtitle-text">Quantity</span><br>
							<input type="number" id="P8Qty" name="P8Qty" value="1" min="1" max="<?php echo GetStock(15)?>" style="width: 50px; height: 35px; font-family: poppins; font-size: 110%; text-align: center; color: #001858; border-radius: 10px; border: none;">
					</td>
				</tr>
				<tr>
					<td>
					...
					<div class="main-text"> Launched by the design house of Parfums de Marly in the year 2016
				This oriental floral fragrance has a blend of bergamot, lavender, apple, mandarin orange, 
				jasmine, geranium, guaiac wood, patchouli, sandalwood, cardamom, vanilla, and pepper.</div>
