...
<body>
	...
	<!--single product details-->
		...
		<div class="right-box">
			<div class="row">
				<div class="col-2">
					<img src="img/products/p7.png" width="100%">
				</div>
				
				<div class="product-details">
					<div class="subtitle-text"> <?php GetProName(13)?> </div>
					<div class="spacer3"></div>
					<h4> (Women) </h4>
					<div class="spacer3"></div>
			...
			<table >
				<tr>
					<td>
						...
						<label>
							<input type="radio" id="P7C1" value="12" name="Radio" checked="checked" onclick="MaxAva7(<?php echo GetStock(13)?>, <?php GetPrice(13)?>)">
							<?php GetSize(13)?> $<?php GetPrice(13)?>
						</label>
						<p style="font-family: poppins;padding-bottom:5px;">stock: <?php echo GetStock(13)?></p>
						<label>
							<input type="radio" id="P7C2" value="13" name="Radio" onclick="MaxAva7(<?php echo GetStock(14)?>, <?php GetPrice(14)?>)">
							<?php GetSize(14)?> $<?php GetPrice(14)?>
						</label>
						<p style="font-family: poppins;padding-bottom:10px;">stock: <?php echo GetStock(14)?></p>
					</td>
				</tr>
				<tr>
					<td>
						<span class="subtitle-text">Quantity</span><br>
							<input type="number" id="P7Qty" name="P7Qty" value="1" min="1" max="<?php echo GetStock(13)?>" style="width: 50px; height: 35px; font-family: poppins; font-size: 110%; text-align: center; color: #001858; border-radius: 10px; border: none;">
					</td>
				</tr>
				<tr>
					<td>
					...
					<div class="main-text"> Electric Cherry merges the scent of Morello cherry with the warmth of musk and sultry jasmine, evoking a teasing flirt sparkling with playful effervescence.
					It feels like an easy way for anyone to try a fruit scent that won't overpower. 
					</div>
