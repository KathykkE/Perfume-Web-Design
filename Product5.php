...
<body>
	...
	<!--single product details-->
		...
		<div class="right-box">
			<div class="row">
				<div class="col-2">
					<img src="img/products/p3.jpg" width="90%">
				</div>
				
				<div class="product-details">
					<div class="subtitle-text"> <?php GetProName(5)?> </div>
					<div class="spacer3"></div>
					<h4> (Men) </h4>
					<div class="spacer3"></div>
			...
			<table >
				<tr>
					<td>
						...
						<label>
							<input type="radio" id="P3C1" value="4" name="Radio" checked="checked" onclick="MaxAva3(<?php echo GetStock(5)?>, <?php GetPrice(5)?>)">
							<?php GetSize(5)?> $<?php GetPrice(5)?>
						</label>
						<p style="font-family: poppins;padding-bottom:5px;">stock: <?php echo GetStock(5)?></p>
						<label>
							<input type="radio" id="P3C2" value="5" name="Radio" onclick="MaxAva3(<?php echo GetStock(6)?>, <?php GetPrice(6)?>)">
							<?php GetSize(6)?> $<?php GetPrice(6)?>
						</label>
						<p style="font-family: poppins;padding-bottom:10px;">stock: <?php echo GetStock(6)?></p>
					</td>
				</tr>
				<tr>
					<td>
						<span class="subtitle-text">Quantity</span><br>
							<input type="number" id="P3Qty" name="P3Qty" value="1" min="1" max="<?php echo GetStock(5)?>" style="width: 50px; height: 35px; font-family: poppins; font-size: 110%; text-align: center; color: #001858; border-radius: 10px; border: none;">
					</td>
				</tr>
				<tr>
					<td>
					...
					<div class="main-text"> This aromatic woody fragrance features an intense power of minty freshness exploding with elegant lavender. 
					An eau de parfum to galvanize the senses. Invigorating grapefruit and absinth clash with richer and masculine notes of patchouli and cypress: a woody finish to bring strength and complexity. 
					Discover a radical cocktail of pure power and elegance.
					</div>
