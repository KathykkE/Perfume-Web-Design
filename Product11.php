...
<body>
	...
	<!--single product details-->
		...
		<div class="right-box">
			<div class="row">
				<div class="col-2">
					<img src="img/products/p6.png" width="90%">
				</div>
				
				<div class="product-details">
					<div class="subtitle-text"> <?php GetProName(11)?> </div>
					<div class="spacer3"></div>
					<h4> (Women) </h4>
					<div class="spacer3"></div>
			...
			<table >
				<tr>
					<td>
						...
						<label>
							<input type="radio" id="P6C1" value="10" name="Radio" checked="checked" onclick="MaxAva6(<?php echo GetStock(11)?>, <?php GetPrice(11)?>)">
							<?php GetSize(11)?> $<?php GetPrice(11)?>
						</label>
						<p style="font-family: poppins;padding-bottom:5px;">stock: <?php echo GetStock(11)?></p>
						<label>
							<input type="radio" id="P6C2" value="11" name="Radio" onclick="MaxAva5(<?php echo GetStock(12)?>, <?php GetPrice(12)?>)">
							<?php GetSize(12)?> $<?php GetPrice(12)?>
						</label>
						<p style="font-family: poppins;padding-bottom:10px;">stock: <?php echo GetStock(12)?></p>
					</td>
				</tr>
				<tr>
					<td>
						<span class="subtitle-text">Quantity</span><br>
							<input type="number" id="P6Qty" name="P6Qty" value="1" min="1" max="<?php echo GetStock(11)?>" style="width: 50px; height: 35px; font-family: poppins; font-size: 110%; text-align: center; color: #001858; border-radius: 10px; border: none;">
					</td>
				</tr>
				<tr>
					<td>
					...
					<div class="main-text"> Herba Fresca is a spontaneous and natural Eau de Toilette, an invitation to walk barefoot in freshly cut grass sparkling with dew. 
					A note of fresh herbs sparkling with dew and springtime flowers, energised by a bunch of spearmint leaves and connected by a green tea accord.
